...
public struct ContractMessages {
    ...
    public static let fallback = "No se pudo completar la operación."
    ...
    public func userMessage(_ error: Error) -> String {
    ...
    public func userMessage(_ error: DomainError) -> String {
