...
Task 12: PENDIENTE y es del usuario, no mío: el **Step 4, verificar el pie en pantalla**. Es el primer paso del runbook de demo y no es automatizable desde acá: hay que levantar las cuatro apps y mirar que el pie diga el mismo string. Los seis binarios coinciden, que es la condición necesaria; la suficiente la da la pantalla.
